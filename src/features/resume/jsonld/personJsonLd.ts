    ...
    "@graph": [
      {
        ...
        contactPoint: {
          "@type": "ContactPoint",
          telephone: contact.phone || "+91 9503125836",
          email: contact.email,
      ...
      },
      {
        ...
        alternateName: [
          "Sanket Patel",
          "Sanket Patel Software Engineering",
          "sanketpatel.online",
        ],
        ...
        image: `${siteUrl}/logo.png`,
        description:
          "Official software engineering portfolio and professional consulting services of Sanket Patel, Full-Stack Developer and Backend Specialist.",
        email: contact.email,
        telephone: contact.phone || "+91 9503125836",
        address: {
          "@type": "PostalAddress",
      ...
      },
      {
        ...
        url: `${siteUrl}/`,
        name: "Sanket Patel Portfolio",
        alternateName: "Sanket Patel Official Portfolio",
      ...
      },
      {
        ...
        "@id": `${siteUrl}/#webpage`,
        url: `${siteUrl}/`,
        name: `${profile.name} Portfolio | ${profile.title} & Backend Specialist`,
